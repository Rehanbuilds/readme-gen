    ...
    <Card className="border-2 border-primary/20 bg-primary/5">
      ...
      <CardContent className="space-y-4">
        <Textarea
          ...
          disabled={isLoading}
        />
        <Button onClick={analyzeProject} disabled={isLoading || !input.trim()} className="w-full rounded-full">
          {isLoading ? (
            <>
        ...
        {isLoading && object && (
          <div className="text-sm text-muted-foreground">
            ...
            {object.projectName && <p className="truncate">Project: {object.projectName}</p>}
          </div>
        )}
      </CardContent>
    </Card>
